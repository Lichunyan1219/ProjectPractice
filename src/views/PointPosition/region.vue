  ...
  <div class="regionalManagement">
    ...
    <div class="top">
      <el-form class="form" label-position="right" label-width="80px">
        <search title="区域搜索:" :model.sync="searchContent"></search>
        <lsButton
          icon="el-icon-search"
          size="mini"
          title="查询"
    ...
    <div class="new">
      ...
      <el-table ref="aabb" :data="regionalManagementData.currentPageRecords">
        ...
        <tableColumn title="区域名称" label="name"></tableColumn>
        <tableColumn title="点位数" label="nodeCount"></tableColumn>
    ...
    <div class="bottom">
      <div class="left">
        <span
          >共<span>{{ regionalManagementData.totalCount }}</span
          >条记录</span
        >
        <span
          >第<span>{{ regionalManagementData.pageIndex }}</span
          >/<span>{{ regionalManagementData.totalPage }}</span
          >页</span
        >
      </div>
      <div class="right">
